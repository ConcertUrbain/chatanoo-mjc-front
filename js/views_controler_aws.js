...
var AppView = Backbone.View.extend({
	...
	initUploadForm: function() {
		...
		AWS.config.credentials = new AWS.CognitoIdentityCredentials({
		  IdentityPoolId: t.mediaCognitoPool // 'eu-west-1:b263aeab-02ae-4268-b338-95e7ea79e255'
		});
    	...
    	var bucketName = t.mediaInputBucket; //'chatanoo-medias-input';
	...
	tryToLoadConvertedMedia: function( mediaAWSKey, callback ) {
		...
		var t = this;
		var s3 = new AWS.S3({apiVersion: '2006-03-01'});
		var bucketName = t.mediaOutputBucket; // "chatanoo-medias-output";
	...
	ajax: function (serviceName, data, successCallback) {
		...
		var ajaxRequest = {
			...
			type: "POST",
			url: t.serviceURL + "/" + serviceName + "/json",
